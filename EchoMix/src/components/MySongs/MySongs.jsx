...
function MySongs() {
  ...
  async function getSongList() {
    try {
      const response = await axios.get(
        `http://localhost:8080/song/getArtistSongs/${user.userName}`
      );
  ...
  function displayArtistSong(src) {
    return (
      <div
        className="MySongs-SongCard"
        onClick={() => {
          handleSongClick(src);
          setSong(src);
        }}
      >
        <div className="MySongs-SongCardImg">
          <img
          ...
          <div className="MySongs-songTitle">
            <p>{src.songName}</p>
          </div>
  ...
  return (
    <>
      <div className="MySongs-container">
        <NavBar className="MySongs-navBar" />
        <div className="MySongs-mainContent">
          <div className="MySongs-profileBarAndList">
            <div className="MySongs-songList">
              {songList.length > 0 ? (
          ...
          {song ? (
            <div className="MySongs-playingContainer">
              <div className="MySongs-nowImage">
                <p>Now Playing...</p>
              </div>
              <div className="MySongs-nowPlayingContainer">
                <img src={getArtistImgSrc(song.artistName)} alt="" />
                <div className="MySongs-playingTitleContainer">
                  <p className="MySongs-playingSongName">{song.songName}</p>
                  <p className="MySongs-playingArtistName">{song.artistName}</p>
                </div>
                <audio
                  className="MySongs-audioBar"
                  controls
                  preload="metadata"
                  loop
            ...
            <div className="MySongs-playingContainer">
              ...
              <div className="MySongs-nowPlayingContainer">
                ...
                />
                <div className="MySongs-playingTitleContainer">
                  <p className="MySongs-playingSongName" hidden>
                    SongName
                  </p>
                  <p className="MySongs-playingArtistName" hidden>
                    ArtistName
                  </p>
                </div>
                <audio

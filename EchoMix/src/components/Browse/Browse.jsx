...
function Browse() {
  ...
  function createArtistCard(src, artistName) {
    return (
      <div className="browse-pArtistCardClass">
        <img src={src} className="browse-pArtistCardImgClass" />
        <p>{`${artistName}`}</p>
      </div>
    );
  }
